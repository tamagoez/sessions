...
export function getStatus(id) {
  ...
  function getfunc() {
    ...
    console.log("[getfunc] got from sessionstorage: " + lastobject["status"]["fcae7f56-7e48-4307-a764-991be77874b1"])
    if (!lastobject["status"]["fcae7f56-7e48-4307-a764-991be77874b1"]) {
